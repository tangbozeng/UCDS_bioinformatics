...
samtools view -hSbo SRR2584857.bam SRR2584857.sam #Convert the SAM file into a BAM file that can be sorted and indexed
samtools sort SRR2584857.bam SRR2584857.sorted #Sort the BAM file by position in genome
samtools tview SRR2584857.sorted.bam ecoli-rel606.fa #Visualize with tview:
